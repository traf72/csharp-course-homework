...
/*************************************************************************************
    4. В строке ниже переменная "z" инкрементируется, а затем выводится на консоль.
       ...
       Объясните, почему на консоле мы видим именно число -128.
*************************************************************************************/
...
var bigNum = 1_984_923_475;
int overflow1 = bigNum * 2;

var overflow2 = short.MinValue;
overflow2--;
...
// Для выполнения заданий ниже отключите глобальную проверку переполнений, а также уберите все явные проверки переполнений,
// иначе из-за ошибки программа просто прервется и не дойдёт до строк ниже.
