...
/*********************************************************************************************************
    6. Я ожидаю на консоле 9, но почему-то получаю 8. Почему? Предложите несколько вариантов исправления.
*********************************************************************************************************/
...
/************************************************************************************************************
    8. Вы вычисляете длину окружности радиусом R, а затем сравниваете её с референсным значением.
       Если посчитать длину на калькуляторе, то видно, что она в точности совпадает с эталоном.
       Но, тем не менее, на консоле выводится, что они не равны.
       В чём причина?
       Как можно исправить данную ситуацию, если погрешность, с которой вы готовы мириться, равна 0.00001?
************************************************************************************************************/

var radiusInMeters = 1.6;
var circleLength = 2 * 3.14 * radiusInMeters;
var referenceLength = 10.048;
var areEqual = circleLength == referenceLength;

Console.WriteLine($"Совпадает с референсным значением: {(areEqual ? "Да" : "Нет")}");
